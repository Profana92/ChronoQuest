...
import { unequipItem } from "@/actions/playerActions";
import { useRouter } from "next/navigation";

const EquippedItemClient = ({ itemData, characterName }: { itemData: string; characterName: string }) => {
        ...
        >
          ...
          <div className="">
            ...
            <button
              ...
              onClick={() => {
                unequipItem({ characterName, itemToUnequip: itemDataObj });
                router.refresh();
              }}
            >
              Unequip
...
export default EquippedItemClient;
